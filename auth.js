/* auth.js - Shared Supabase + JobApplyAI auth helpers
   IMPORTANT:
...
(() => {
  ...
  // ============================================================
  // 3) Ensure sb_url + sb_anon exist (THIS FIXES YOUR ERROR)
  // ============================================================
  ...
  if (!window.supabase || typeof window.supabase.createClient !== "function") {
    console.error(
      "[auth.js] supabase-js v2 is not loaded. Include https://unpkg.com/@supabase/supabase-js@2 BEFORE auth.js"
    );
    return;
  }
